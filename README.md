...
An easy way to identify the bones of your website.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display block allows items to be stacked on each other, display inline will allow the content to be shown within the line (where display block will not)
...
Git is valuable to a team of developers because it allows you to have version control of the project that you're working on.
